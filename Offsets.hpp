    ...
    constexpr long OFFSET_IN_FORWARD = 0x07543e58; //[Buttons]->in_forward
    ...
    constexpr long OFF_VIEW_RENDER = 0x7543e00; //[RecvTable.DT_Player]->ViewRender
    ...
    constexpr long OFF_LAST_AIMEDAT_TIME = 0x19a4 + 0x8; 
    ...
    constexpr long OFF_SPECTATOR_LIST = 0x1efae58;                //IDA signtature -> [48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38]
